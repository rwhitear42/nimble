 ...
 *
 */
public class NimbleVolumeCollectionsReport extends CloupiaReportWithActions {
	
	private static final String NAME = "nimble.volume.collections.report";
	private static final String LABEL = "Volume Collections";
	
	public NimbleVolumeCollectionsReport() {
		super();
		...
		/*
		this.setMenuID(NimbleConstants.DUMMY_MENU_WHITNEY_1);
	...
	@Override
	public Class<NimbleVolumeCollectionsReportImpl> getImplementationClass() {
		//this class handles all the report generation logic, look here for more details
		return NimbleVolumeCollectionsReportImpl.class;
	}
