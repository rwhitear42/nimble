 ...
 *******************************************************************************/
package com.cloupia.feature.nimble.accounts.pagination;
 ...
 *
 */
public class NimbleAccountReportHandler extends PaginatedReportHandler {

	static Logger logger = Logger.getLogger(NimbleAccountReportHandler.class);
	
	/*
	 * This method is used to get sub query.
	 * @return Query This returns Query(Ex:accountName= 'Test-Nimble-Account')
	 */
	@Override
