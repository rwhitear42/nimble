 ...
 *
 */
public class NimbleControllerMembersReport extends CloupiaReportWithActions {
	
	private static final String NAME = "nimble.controller.members.report";
	private static final String LABEL = "Controller Members";
	
	public NimbleControllerMembersReport() {	
		super();		
	...
	public Class getImplementationClass() {
		...
		return NimbleAccountSampleReportImpl.class;
	}
	...
	public Class getPaginationModelClass() {
		...
		return NimbleControllerMembersAccountReport.class;
	}
