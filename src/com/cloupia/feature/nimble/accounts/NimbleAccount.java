...
@PersistenceCapable(detachable = "true", table = "nimble_account")
public class NimbleAccount extends AbstractInfraAccount implements
		ConnectorCredential {

	static Logger logger = Logger.getLogger(NimbleAccount.class);
