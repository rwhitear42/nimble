 ...
 *
 */
public class NimbleInitiatorGroupsReport extends CloupiaReportWithActions {
	
	private static final String NAME = "nimble.initiator.groups.report";
	private static final String LABEL = "Initiator Groups";
	
	public NimbleInitiatorGroupsReport() {	
		super();		
	...
	@Override
	public Class<NimbleInitiatorGroupsReportImpl> getImplementationClass() {
		//this class handles all the report generation logic, look here for more details
		return NimbleInitiatorGroupsReportImpl.class;
	}
