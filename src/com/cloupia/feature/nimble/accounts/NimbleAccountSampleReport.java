 ...
 *
 */
public class NimbleAccountSampleReport extends CloupiaReportWithActions {
	
	private static final String NAME = "nimble.account.sample.report";
	private static final String LABEL = "Please Just Fucking Work";
	
	public NimbleAccountSampleReport() {	
		super();		
