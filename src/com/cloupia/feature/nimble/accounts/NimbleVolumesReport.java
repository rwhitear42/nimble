 ...
 *
 */
public class NimbleVolumesReport extends CloupiaReportWithActions {
	
	private static final String NAME = "nimble.volumes.report";
	private static final String LABEL = "Volumes";
	
	public NimbleVolumesReport() {
		super();
	...
	public Class getImplementationClass() {
		...
		return NimbleVolumesReportImpl.class;
	}
