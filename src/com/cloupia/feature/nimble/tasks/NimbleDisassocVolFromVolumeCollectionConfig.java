...
@PersistenceCapable(detachable = "true", table = "nimble_disassocvolfromvolcolltask")
public class NimbleDisassocVolFromVolumeCollectionConfig implements TaskConfigIf {
	...
	public NimbleDisassocVolFromVolumeCollectionConfig() {

	}
	
	public NimbleDisassocVolFromVolumeCollectionConfig(NimbleAssocVolToVolumeCollectionConfig config) {
