...
@PersistenceCapable(detachable = "true", table = "nimble_removefcinitiatorfromigrouptask")
public class NimbleRemoveFcInitiatorFromIgroupConfig implements TaskConfigIf {
	...
	public NimbleRemoveFcInitiatorFromIgroupConfig() {

	}
	
	public NimbleRemoveFcInitiatorFromIgroupConfig(NimbleAddFcInitiatorToIgroupConfig config) {
