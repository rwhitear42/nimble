...
@PersistenceCapable(detachable = "true", table = "nimble_nimbledeletevolumetask")
public class NimbleDeleteVolumeConfig implements TaskConfigIf {
	...
	public NimbleDeleteVolumeConfig() {

	}
	
	public NimbleDeleteVolumeConfig(NimbleCreateVolumeConfig config) {
