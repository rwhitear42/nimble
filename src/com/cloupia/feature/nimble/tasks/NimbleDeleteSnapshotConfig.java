...
@PersistenceCapable(detachable = "true", table = "nimble_nimbledeletesnapshottask")
public class NimbleDeleteSnapshotConfig implements TaskConfigIf {
	...
	public NimbleDeleteSnapshotConfig(NimbleCreateSnapshotConfig config) {
	...
	public NimbleDeleteSnapshotConfig() {
