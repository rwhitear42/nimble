...
@PersistenceCapable(detachable = "true", table = "nimble_removeiscsiinitiatorfromigrouptask")
public class NimbleRemoveIscsiInitiatorFromIgroupConfig implements TaskConfigIf {
	...
	public NimbleRemoveIscsiInitiatorFromIgroupConfig() {

	}
	
	public NimbleRemoveIscsiInitiatorFromIgroupConfig(NimbleAddIscsiInitiatorToIgroupConfig config) {
