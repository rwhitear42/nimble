 ...
 *
 */
public class NimbleAccountSampleDrillDownChildReport extends
		CloupiaEasyDrillableReport {
	static Logger logger = Logger.getLogger(NimbleAccountSampleDrillDownChildReport.class);
	...
	public NimbleAccountSampleDrillDownChildReport(String name, String label,
			Class dbSource) {
	...
	public Class getImplementationClass() {
		...
		// more details
		return null;// NimbleAccountSampleReportImpl.class;
	}
	...
	public Class getPaginationProvider() {
		// TODO Auto-generated method stub
		return NimbleAccountDrillDownReportHandler.class;
	}
